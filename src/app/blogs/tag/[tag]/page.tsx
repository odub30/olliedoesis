...
import { Breadcrumb, getTagBreadcrumbs } from "@/components/blog/breadcrumb";
...
export async function generateMetadata({ params }: TagPageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: `Explore ${posts.length} blog posts tagged with ${tagName}. Find tutorials, guides, and insights.`,
    openGraph: {
      title: `${tagName} - Blog Tags`,
      description: `Explore ${posts.length} blog posts tagged with ${tagName}.`,
      type: "website"
    }
  };
}
        ...
        <div className="mb-12">
          ...
          <div className="flex flex-wrap gap-2 pt-6 border-t">
            ...
            {allTags
              ...
              .slice(0, 10)
              .map(tag => (
                <a key={tag} href={`/blogs/tag/${tagToSlug(tag)}`}>
